    ...
    return (
      <>
        <form onSubmit={this.handleSubmit}>
          ...
          <label>
            Sou:
            <input type="radio" checked={this.state.tipo === 'programadora'} onChange={this.changeRadio} value='programador'/> Programador(a)
            <input type="radio" checked={this.state.tipo === 'estudante'} onChange={this.changeRadio} value='estudante'/> Estudante
          </label>
          <br />
          <label>
            <input type="checkbox" checked={this.state.dedico} onChange={this.changeCheckbox}/> Dedico 8hs semanais aos estudos.
          </label>
          <br />
          <label>
            Bio:
